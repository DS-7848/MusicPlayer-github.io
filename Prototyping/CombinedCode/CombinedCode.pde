...
int appHeight = displayHeight; //height:500
 ...
 float playSymbolX1 = playX + playWidth * 2/8;
 ...
 float stopX1 = stopX + stopWidth * 2/8;
 float stopY1 = stopY + stopHeight * 1/8;
 float stopWidth1 = stopWidth * 1/8;
 float stopHeight1 = stopHeight * 6/8;
 rect(stopX1, stopY1, stopWidth1, stopHeight1);
 
 float stopX2 = stopX + stopWidth * 5/8;
 float stopY2 = stopY + stopHeight * 1/8;
 float stopWidth2 = stopWidth * 1/8;
 float stopHeight2 = stopHeight * 6/8;
